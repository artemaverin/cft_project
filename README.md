...
Комментарии:
Класс Sort - запускает проект

классы SortInt & SortStr имплементят интерфейс SortType и реализуют логику сортировки

класс CommandArgs обрабатывает данные параметров программы